...
# Decompiled By ARIYAN SHUVO

# Youtube : https://youtube.com/channel/UCxsi4JIa6F5KU9o1QC

# uncompyle6 version 

# Original written By ARIYAN SHUVO

import os, sys, time, datetime, random, hashlib, re, threading, json, urllib, cookielib, getpass

__author__ = 'NAHID'

__copyright = 'NLS rights reserved . Copyright  𝙉𝘼𝙃𝙄𝘿 KHAN'
...
while (loop == 'true'):
    ...
    username = raw_input('\033[1;91mENTER TOOL KEYâ€¦â€¦â€¦â€¦=>> :\033[1;93m ')
    ...
    if (username == CorrectUsername):
            ...
            os.system('xdg-open https://youtube.com/shorts/Z2_dM-ykcII?feature=share)
        ...
        os.system('xdg-open https://youtube.com/channel/UC6vP3DZ8N_VcXSW5LcJKmWw')
...
/YOUTUBE CHANNEL SUBSCRIBE LAZMI KARNI HA  <::::::::::::::::[]

 ______________________________________________
[•] Author   :            NAHID KHAN
[•] Facebook link  :          real.picchi.s3xy.prem.vau
[•] Github  :    ariyan404
[•] Version  :              0.6
[•] Status : Mister Mind 😏
______________________________________________
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                print '\x1b[92m  [Sucessfull-𝙉𝘼𝙃𝙄𝘿]  ' + k + c + user + '  |  ' + pass1
                ...
                print '\x1b[1;91m  [Sucessfull-𝙉𝘼𝙃𝙄𝘿] ' + k + c + user + '  |  ' + pass1
                ...
                if 'access_token' in q:
                    ...
                    print '\x1b[1;92m  [Sucessfull-𝙉𝘼𝙃𝙄𝘿] ' + k + c + user + '  |  ' + pass2
                    ...
                    if 'access_token' in q:
                        ...
                        print '\x1b[1;92m  [Sucessfull-𝙉𝘼𝙃𝙄𝘿]  ' + k + c + user + '  |  ' + pass3
